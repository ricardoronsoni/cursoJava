...
public class Cliente implements Serializable{
	...
	@ElementCollection  //para trabalhar com a entidade fraca
	...
	public Cliente(Integer id, String nome, String email, String cpfOuCnpj, TipoCliente tipo) {
		...
		this.tipo = tipo.getCod();  //isso é para receber um obejto enumerado e gravar nessa classe o codigo do enum
	}
	
	//atualizado para receber um objeto do tipocliente e devolver um integer
	public TipoCliente getTipo() {
		return TipoCliente.toEnum(tipo);
	}

	//atualizado para pegar o codigo
